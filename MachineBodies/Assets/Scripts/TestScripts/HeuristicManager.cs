...
public class HeuristicManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        neuralNetworkHeuristic = new NeuralNetwork_Heuristic(netExtents[0], netExtents[1], netExtents[2], netExtents[3]);
        neuralNetworkHeuristic.InnitializeNeuralNetworksHe();
        ...
        creatures = RepopulateCreatures(neuralNetworkHeuristic.GetPolicyNeuralNetwork());
    }
    ...
    private void AdvanceGeneration()
    {
        ...
        neuralNetworkHeuristic.Train(experiences);
        NeuralNetwork newPolicyNetwork = neuralNetworkHeuristic.GetPolicyNeuralNetwork();
